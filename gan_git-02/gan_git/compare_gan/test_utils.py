...
import sys
sys.path.append('/content/drive/My Drive/drive/gan/gan_git-02/gan_git/compare_gan/tpu/')
sys.path.append('/content/drive/My Drive/drive/gan/gan_git-02/gan_git/compare_gan/metrics/')
...
class Discriminator(abstract_arch.AbstractDiscriminator):
  ...
  def apply(self, x, y, is_training):
    ...
    h = tf.reduce_mean(input_tensor=x, axis=[1, 2])
